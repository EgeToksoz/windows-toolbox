...
diskpart /s lv.txt
del lv.txt
set /P vt=Choose the Drive Letter for Ventoy Mounted ISO Partition: 
...
cls
dism /get-wiminfo /wimfile:"%vt%\sources\install.wim"
set /P IND=Choose the Index Number from Selected File: 
dism /Apply-Image /ImageFile:"%vt%\sources\install.wim" /Index:%IND% /ApplyDir:%WIN%
cls
goto efi
:custom
Echo list vol > "lv.txt"
